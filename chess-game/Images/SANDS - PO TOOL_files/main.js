...
var routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "master",
        loadChildren: () => import("/routes-JTTIY5CD.js").then((m) => m.routes),
        canActivate: [authGuard]
      },
      {
        path: "crmmanagement",
        loadChildren: () => import("/routes-GXQ72MVR.js").then((m) => m.routes),
        canActivate: [authGuard]
      },
      {
        path: "marketing",
        loadChildren: () => import("/routes-SG7ASHDA.js").then((m) => m.routes),
        canActivate: [authGuard]
      },
      {
        path: "usermanagement",
        loadChildren: () => import("/routes-33B7RUK7.js").then((m) => m.routes),
        canActivate: [authGuard]
      },
      {
        path: "dashboardpo",
